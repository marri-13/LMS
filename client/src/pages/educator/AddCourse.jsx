...
const AddCourse = () => {
      ...
      setChapters(
        chapters.map((chapter) => {
          if(chapter.chapterId === chapterId){
            chapter.chapterContent.slic(lectureIndex, 1);
          }
          return chapter;
        })
      );
  ...
  return (
    <div className="h-screen overflow-scroll flex flex-col items-start justify-between md:p-8 md:p-0 p-4 pt-8 pb-0">
