    ...
    <div className='md:px-36 px-8 pt-10'>
      ...
      <table className='md:table-auto table-fixed w-full overflow-hidden border mt-10'>
        <thead className='text-gray-900 border-b border-gray-500/20 text-sm text-left max-sm:hidden'>
          <tr>
            <th className='px-4 py-3 font-semibold tuncate'>Course</th>
            <th className='px-4 py-3 font-semibold tuncate'>Duration</th>
            <th className='px-4 py-3 font-semibold tuncate'>Completed</th>
            <th className='px-4 py-3 font-semibold tuncate'>Status</th>
          </tr>
        </thead>
